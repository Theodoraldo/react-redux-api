...
# 📖 React Redux Tutorial on API <a name="about-project"></a>

**React Redux Tutorial on API** App connects to an API via React-Redux and randomly displays users first and last name to the UI.
...
- cd my-folder
- git clone https://github.com/Theodoraldo/react-redux-api.git
